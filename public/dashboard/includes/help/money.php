...
<p><code>GET /dashboard/api/money-summary.php</code> returns pulse + ledger shaped for the caller’s role (agent keys elevate to ops-equivalent book reads). Details in <a href="/dashboard/help.php?page=api">HTTP API</a>.</p>
