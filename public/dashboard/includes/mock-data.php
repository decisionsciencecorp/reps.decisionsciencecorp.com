...
function repsDashMockShops(): array
{
    return [
        [
            ...
            'notes' => 'Internal DSC kitchen lane.',
            'operators' => 3,
        ...
        [
            ...
            'contact_name' => 'Leon Gardner',
            'contact_phone' => '(972) 555-0199',
            'agreed_shop_split' => 0.5,
            'notes' => 'Leon Gardner — Seven Mobile Detail (affiliate + worker).',
            'operators' => 1,
...
function repsDashMockOperators(): array
{
    return [
        ...
        ['id' => 5, 'name' => 'Leon Gardner', 'shop_id' => 103, 'shop' => 'Seven Mobile Detail', 'phone' => '(972) 555-0199', 'status' => 'active', 'matched' => true, 'assigned_sales_rep' => 'seven', 'accepted_7d' => 6.2, 'rejected_7d' => 1.8, 'last_session' => '2026-08-04 16:01'],
